...
public class IndexController {
    ...
    public Integer saveStudentTask(Integer id, String answer, HttpSession session) {
        List<Answer> answers = (List<Answer>) session.getAttribute("answers") == null ? new ArrayList<Answer>() : (List<Answer>) session.getAttribute("answers");
        boolean flag = false;
